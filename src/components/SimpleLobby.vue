    ...
    <div v-else class="room">
      ...
      <div class="players">
        <div class="player host-card" :class="{ 'active': isHost }">
          ...
          <div class="player-name">{{ isHost ? 'Вы' : hostName }}</div>
      ...
      <div v-if="isHost" class="host-controls">
        <div v-if="!guestName" class="waiting-message">
          <p>⏳ Ожидание гостя...</p>
        </div>
        <div v-else-if="guestName && !guestReady" class="waiting-message">
          <p>⏳ Гость еще не готов</p>
        </div>
        <div v-else-if="guestName && guestReady" class="start-section">
          <button @click="hostStartGame" class="start-btn">
            🎮 Начать игру
          </button>
        </div>
      </div>
